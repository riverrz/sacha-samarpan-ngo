...
mongoose.connect("mongodb://localhost/sacha_samarpan");
...
app.post("/registration", async (req,res)=> {
  ...
  res.send("Thank You for becoming a member of our NGO. We wish a great journey helping needy people. Thank you again")
})
