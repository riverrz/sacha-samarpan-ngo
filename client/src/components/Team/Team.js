  ...
  state = {
    member: [
      ...
      },
      {
        ...
        description:
          "Rohit Shukla is one of the dedicated volunteer in Saccha Samarpan NGO. He has completed his MA in History from Delhi University with first Division.He is also RBI certified from Indian Institute Of Banking and Finance. He has also qualified many competitive exams like CDS,CGL,CISF,ITBP, Delhi Police and Banking, and presently running an competitive exam Institute and hope to teach free of cost in Saccha Samarpan. Rohits’s vision is that no child  should be left behind in field of education because of financial deprivation."
      },
      {
        name: "Aman Gupta",
        designation: "Volunteer",
      ...
      },
      {
        ...
        description:
          "Kaushal Arora is a qualified degree holder in B.Tech computer Science from Jamia Hamdard University. He devotes all his kindness and hardwork to the organisation. Before you give up on yourself remember what your parents gave to just get you where you are."
      },
      {
        name: "Umesh Rajput",
        designation: "Volunteer",
