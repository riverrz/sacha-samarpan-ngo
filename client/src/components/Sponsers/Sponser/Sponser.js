    ...
    sponsers: [
      {
        ...
        since: "2006",
        description:
          "Shri Kalka Construction Company has lead and worked as an integral part of many ventures in developing integrated townhouses, group housing, shopping malls, multiplexes, hotels and IT parks.This company is the main pillar of Saccha Samarpan which provide and allocate all the beneficial resources to the organisation.",
        address: "C-53 Jawahar Park, Devli Road,Khanpur, New Delhi-110080",
        name: "Shri Kalka Construction Company",
        phone: "9212580053",
        email: "nauratnag@gmail.com",
        mapSrc:
      ...
      },
      {
        ...
        since: "2000",
        description:
          "MTI provides various courses for woman like Cutting and Tailoring, Beauty Culture, Computer Course, Fashion Designing and many more.Its main motto is to educate and empower women. Along this, it plays a vital role in Saccha Samarpan and taken an initiative to help and support the organisation to its best.",
      ...
      },
      {
        logo: "3.png",
        title:
          "Ayurvedic Treatment for Hair loss, Weakness, Weight loss/Gain, Sexual Problems and Infertility.",
        since: "",
        description:
      ...
      },
      {
        logo: "5.jpg",
        title:
          "All types of under garment , lowers ,T-Shirts, gowns, plazo . One of the best Retail Shop for garments.",
        since: "2010",
        description:
          "Aggarwal Undergarments is a major partner and plays a productive role to enhance the growth of the society by helping and supporting Saccha Samarpan NGO.",
